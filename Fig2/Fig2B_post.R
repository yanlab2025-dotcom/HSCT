...
#data input preparation and transformation
    metadata <- metadata[metadata$In_out == "Out", ] #"In" represents "Pre-HSCT"
    ...
    dist.metagenome <- vegdist(metagenome_OUT , method="bray")
...
##################################################
#adding metadata
    mp4.score$Infection <- recode(mp4.score$Infection,
                                  "0" = "No",
                                  "1" = "Yes")
    metadata$Infection <- recode(metadata$Infection,
                                 "0" = "No",
                                 "1" = "Yes")
...
#PCoA generation
    ...
    Fig2B_post <- plot_grid(plotlist = pcoa_plots, ncol = 2, align = "hv")
    Fig2B_post
