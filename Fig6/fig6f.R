...
aGVHD_brm_im$Feature <- factor(aGVHD_brm_im$Feature, levels = aGVHD_brm_im$Feature[order(aGVHD_brm_im$Estimate, decreasing = FALSE)])
Fig6f_1<-ggplot(aGVHD_brm_im, aes(x = Estimate, y = Feature)) +
  geom_point(size = 2) +  
